# class called Employee with attributes first and last
# and a class variable timesheets. The class should have an __init__ method
# Author: Tihana Gray
...
class Employee:
    ...
    def logminutes(self, project, minutes):
        now = dt.datetime.now() - dt.timedelta(minutes=minutes)
